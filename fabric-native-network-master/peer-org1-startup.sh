...
export CORE_PEER_CHAINCODEADDRESS=192.168.1.106:7052
export CORE_PEER_CHAINCODELISTENADDRESS=192.168.1.106:7052
...
/Users/chenziang/go/src/github.com/hyperledger/Fabric_EMVCC-master/build/bin/peer node start  #--peer-chaincodedev=true #-o 127.0.0.1:7050